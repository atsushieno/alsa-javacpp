...
@Properties(
    ...
    target = "dev.atsushieno.alsa.javacpp",
    global = "dev.atsushieno.alsa.javacpp.global.Alsa",
    value = {
        @Platform(
...
public class Alsa implements InfoMapper {
    static { Loader.checkVersion("dev.atsushieno", "alsa-javacpp"); }
    ...
    public void map(InfoMap infoMap) {
        infoMap
            ...
            .put(new Info("snd_pcm_format").skip())
...
//            .put(new Info("mixer_abst.h").linePatterns(".*snd_mixer_class_t .*class.*").skip())
            .put(new Info("pcm.h").linePatterns("#elif __BYTE_ORDER == __BIG_ENDIAN", "#endif").skip());
            ;
    }
}
